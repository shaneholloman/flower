...
| `supernode.appioTls.enabled`                                        | Enable TLS on the SuperNode ClientAppIo API.                                                                            | `false`                    |
| `supernode.appioTls.caCertfile`                                     | Path to the CA certificate used by SuperExec to verify ClientAppIo.                                                     | `/app/cert/ca.crt`         |
| `supernode.appioTls.certfile`                                       | Path to the ClientAppIo server certificate.                                                                             | `/app/cert/tls.crt`        |
| `supernode.appioTls.keyfile`                                        | Path to the ClientAppIo server private key.                                                                             | `/app/cert/tls.key`        |
...
| `supernode.image.tag`                                               | Image tag of SuperNode                                                                                                  | `1.32.1-ubuntu`            |
...
| `supernode.networkPolicy.extraEgress`                               | Add extra egress rules to the NetworkPolicy (ignored if allowExternalEgress=true)                                       | `[]`                       |
...
| `superexec.allowRuntimeDependencyInstallation`                        | Allow SuperExec to install runtime dependencies for ClientApps.                                                                                                                                                                                                                                     | `false`                                   |
