...
| `superlink.appioTls.enabled`                                  | Enable TLS on the SuperLink ServerAppIo API.                                                                            | `false`                   |
| `superlink.appioTls.existingSecret`                           | Existing Kubernetes Secret for ServerAppIo TLS.                                                                         | `""`                      |
| `superlink.appioTls.mountPath`                                | Mount path used when AppIO uses a separate TLS Secret.                                                                  | `/app/appio-cert`         |
| `superlink.appioTls.caCertfile`                               | Path to the CA certificate used by SuperExec to verify ServerAppIo.                                                     | `/app/cert/ca.crt`        |
| `superlink.appioTls.certfile`                                 | Path to the ServerAppIo server certificate.                                                                             | `/app/cert/tls.crt`       |
| `superlink.appioTls.keyfile`                                  | Path to the ServerAppIo server private key.                                                                             | `/app/cert/tls.key`       |
| `superlink.appioTls.certificate.enabled`                      | Enable automatic creation of a cert-manager Certificate for ServerAppIo.                                                | `false`                   |
| `superlink.appioTls.certificate.annotations`                  | Certificate CRD annotations.                                                                                            | `{}`                      |
| `superlink.appioTls.certificate.secretName`                   | Name of the Kubernetes Secret storing the ServerAppIo TLS key and certificate.                                          | `""`                      |
...
| `superlink.appioTls.certificate.dnsNames`                     | DNS names for the ServerAppIo certificate.                                                                              | `[]`                      |
...
| `superexec.rootCertificates`                                          | Path to a PEM-encoded root CA certificate used to verify AppIO.                                                                                                                                                                                                                                     | `""`                                      |
...
| `superexec.executor.kubernetes.appioRootCertificatesPath`             | Path to a PEM-encoded AppIO root CA file to copy into TaskExecutor credential Secrets.                                                                                                                                                                                                              | `""`                                      |
...
| `superexec.taskExecutorNetworkPolicy.extraEgress`                     | Add egress rules from TaskExecutor Pods to AppIO, proxies, registries, or other required services (ignored if allowExternalEgress=true).                                                                                                                                                            | `[]`                                      |
